...
function applyDarkModeToMenuSearchResults() {
  ...
  searchContainers.forEach((container) => {
    ...
    container.querySelectorAll('*').forEach((element) => {
      element.style.backgroundColor = currentStyles.background;
      element.style.color = currentStyles.text;
    });
...
function applyDarkModeToSpecificElements() {
  ...
  if (leftSidebar) {
    ...
    leftChildElements.forEach((child) => {
      child.style.backgroundColor = currentStyles.background;
      child.style.color = currentStyles.text;
    });
  }
